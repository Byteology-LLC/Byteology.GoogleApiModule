...
using Byteology.GoogleApiModule.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(GoogleApiModuleBlazorServerModule)
)]
public class GoogleApiModuleBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(GoogleApiModuleResource),
                typeof(GoogleApiModuleDomainModule).Assembly,
                typeof(GoogleApiModuleDomainSharedModule).Assembly,
                typeof(GoogleApiModuleApplicationModule).Assembly,
                typeof(GoogleApiModuleApplicationContractsModule).Assembly,
                typeof(GoogleApiModuleBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Byteology.GoogleApiModule.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        context.Services.AddAuthentication()
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "GoogleApiModule";
            });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<GoogleApiModuleBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(GoogleApiModuleBlazorHostModule).Assembly;
        });
    ...
    public async override Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "GoogleApiModule API");
        });
