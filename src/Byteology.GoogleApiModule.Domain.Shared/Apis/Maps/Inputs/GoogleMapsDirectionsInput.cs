...
{
    public class GoogleMapsDirectionsInput : BaseChannelInput
    {
        /// <summary>
        ...
        /// </summary>
        [NotNull]
        public LocationEx Origin { get; set; }
        ...
        /// </summary>
        [NotNull]
        public LocationEx Destination { get; set; }

        /// <summary>
        /// Specifies what mode of transport to use when calculating directions. Valid values are driving, walking, bicycling, and transit.
        /// </summary>
        [NotNull]
        ...
        /// </summary>
        [CanBeNull]
        public TrafficModel TrafficModel { get; set; } = TrafficModel.Best_Guess;
        ...
        /// </summary>
        [CanBeNull]
        public AvoidWay Avoid { get; set; } = AvoidWay.Nothing;
        ...
        /// </summary>
        [CanBeNull]
        public TransitMode TransitMode { get; set; } = TransitMode.Bus | TransitMode.Train | TransitMode.Subway | TransitMode.Tram;
        ...
        /// </summary>
        [CanBeNull]
        public TransitRoutingPreference TransitRoutingPreference { get; set; } = TransitRoutingPreference.Nothing;
        ...
        /// </summary>
        [CanBeNull]
        public IEnumerable<WayPoint> Waypoints { get; set; } = default;
